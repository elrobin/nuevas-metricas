...
```{r, echo=FALSE, out.width="100%", fig.cap="Imagen de N. Robinson-Garcia"}
knitr::include_graphics('images/fuente.jpg')
```
...
---------------------                               ------------------------
![](images/dani-torres-salinas300.png)               Profesor del departamento de Información y Comunicación y director de la Unidad de Evaluación Científica de la Universidad de Granada. [Más info](https://sites.google.com/go.ugr.es/torressalinas)

Nicolas Robinson-Garcia                       Mini bio
---------------------                        ------------------------
![](images/nicolas-robinson-garcia300.png)    Profesor del departamento de Información y Comunicación de la Universidad de Granada e investigador Ramón y Cajal. [Más info](https://nrobinsongarcia.com)
